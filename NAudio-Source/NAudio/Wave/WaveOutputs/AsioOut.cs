...
namespace NAudio.Wave
{
    ...
    public class AsioOut : IWavePlayer
    {
        ...
        public void InitRecordAndPlayback(IWaveProvider waveProvider, int recordChannels, int recordOnlySampleRate)
        {
            ...
            nbSamples = driver.CreateBuffers(NumberOfOutputChannels, NumberOfInputChannels, requestedBufferSize);
        ...
        public void InitRecordAndPlayback(int sampleRate, int bufferSize)
        {
            int desiredSampleRate = sampleRate;
        ...
        void driver_BufferUpdate(IntPtr[] inputChannels, IntPtr[] outputChannels)
        {
            ...
            if (this.NumberOfOutputChannels > 0 && sourceStream != null)
            {
